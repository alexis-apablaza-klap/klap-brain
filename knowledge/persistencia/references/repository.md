# Repository — Template JdbcTemplate

Router y reglas: [SKILL.md](../SKILL.md). Este archivo es solo el codigo del
template — `ConstantsQuery`, `XxxRepository`, `XxxRowMapper`, `AuditoriaXxxRepository`.
Paginacion cursor-based: [paginacion.md](paginacion.md).
...
public final class ConstantsQuery {
    ...
    // Paginacion cursor-based (tablas > 500 registros): ver paginacion.md
    // para la constante FIND_BY_CURSOR_AFTER y el metodo asociado.
